...
<?php 
    ...
    $tag = mysqli_fetch_assoc(mysqli_query($db,"SELECT tag FROM tags WHERE id='$id'"))['tag'];
?>
<head>
  <meta charset="UTF-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>DIY Blog - <?php echo $tag; ?></title>
      ...
      <div class="container">
        ...
        <div class="blog">
          ...
          <div class="blog-card-group">
            ...
            <?php 
              $sql = mysqli_query($db,"SELECT  image,type,blog.id,title,content FROM blog INNER JOIN tags ON blog.id = tags.blog_id WHERE tags.tag = '$tag'");
